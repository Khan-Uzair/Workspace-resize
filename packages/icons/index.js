...
function _templateObject5() {
  var data = _taggedTemplateLiteral(["margin-top: auto;"]);
...
function _templateObject4() {
  var data = _taggedTemplateLiteral(["margin-left: auto;"]);
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["margin: 12px 4px 12px 4px;"]);
...
var menuIconStyling = styled.css(_templateObject(), belowMobileLarge(_templateObject2()), function (props) {
  return props.mobileOnly && aboveMobileLarge(_templateObject3());
}, function (props) {
  return props.mobileOnly && belowMobileLarge(_templateObject4());
}, function (props) {
  return props.stickyIcon && aboveMobileLarge(_templateObject5());
});
var StyledResizeIcon = styled__default.svg(_templateObject6(), function (props) {
  return props.align === "left" ? styled.css(_templateObject7()) : styled.css(_templateObject8());
});
var StyledMenuIcon = styled__default.div(_templateObject9(), menuIconStyling, function (props) {
  return props.isSelected ? props.theme.tescoHighlightSelected : props.theme.tescoBlueDark;
}, function (props) {
  return props.isSelected ? 1 : 0.6;
}, function (props) {
  return props.theme.tescoHighlightSelected;
});
var StyledCloseIcon = styled__default.div(_templateObject10());
var StyledAnalysisIcon = styled__default.div(_templateObject11(), menuIconStyling, function (props) {
  return props.isSelected ? props.theme.tescoHighlightSelected : props.theme.tescoPeacockBlue;
}, function (props) {
  return props.isSelected ? 1 : 0.6;
}, function (props) {
  return props.theme.tescoHighlightSelected;
...
var ResizeIcon = function ResizeIcon(_ref) {
  var _ref$fill = _ref.fill,
      ...
      align = _ref.align;
  return React.createElement(StyledResizeIcon, {
    ...
    fill: fill,
    d: "M15 10l-3 3V7zM5 10l3 3V7z"
  })));
};
var SettingsIcon = function SettingsIcon(props) {
  return React.createElement(StyledMenuIcon, props, React.createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "22",
    height: "22",
    viewBox: "0 0 22 22"
    ...
    d: "M8.875 20.5a3.577 3.577 0 0 0-3.582-3.252c-.516 0-1.025.11-1.493.32l-2.111-3.641A3.61 3.61 0 0 0 3.198 11a3.569 3.569 0 0 0-1.521-2.918l2.128-3.664c.475.216.989.33 1.513.33a3.578 3.578 0 0 0 3.557-3.244l4.25-.004a3.575 3.575 0 0 0 1.777 2.772 3.631 3.631 0 0 0 3.298.16l2.111 3.641a3.613 3.613 0 0 0-1.509 2.928 3.569 3.569 0 0 0 1.52 2.917l-2.127 3.664a3.65 3.65 0 0 0-1.513-.33 3.576 3.576 0 0 0-3.556 3.244l-4.251.004z"
  }))));
};
var CloseIcon = function CloseIcon(props) {
  return React.createElement(StyledCloseIcon, props, React.createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "16",
    height: "16",
    viewBox: "0 0 16 16"
...
var FiltersIcon = function FiltersIcon(props) {
  return React.createElement(StyledMenuIcon, props, React.createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "16",
    height: "19",
...
var AddIcon = function AddIcon(props) {
  return React.createElement(StyledMenuIcon, props, React.createElement("svg", {
    ...
    d: "M0 9L18 9M9 0L9 18"
  }))));
};
var AnalysisIcon = function AnalysisIcon(props) {
  return React.createElement(StyledAnalysisIcon, props, React.createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "17",
    height: "15",
    viewBox: "0 0 17 15"
    ...
    d: "M0 11H1.5V15H0zM5 0H6.5V15H5zM10 5H11.5V15H10zM15 9H16.5V15H15z"
  }))));
};

exports.AddIcon = AddIcon;
exports.AnalysisIcon = AnalysisIcon;
