...
var StyledAppBody = styled__default.div(_templateObject());
var StyledOverlay = styled__default.div(_templateObject2(), function (props) {
  return props.theme.tescoBlueDarker;
}, aboveMobileLarge(_templateObject3(), function (props) {
  return props.isOverlayOpen && styled.css(_templateObject4(), function (props) {
    return props.width;
  });
}), belowMobileLarge(_templateObject5(), function (props) {
  return props.isOverlayOpen && styled.css(_templateObject6());
}));
var StyledPanelBody = styled__default.div(_templateObject7());
var StyledAnalysisIcon = styled__default(icons.AnalysisIcon)(_templateObject8(), aboveMobileLarge(_templateObject9(), function (props) {
  return props.isContentOpen ? "none" : "block";
}), belowMobileLarge(_templateObject10()));
var StyledOverlayContainer = styled__default.div(_templateObject11(), function (props) {
  return styled.css(_templateObject12(), props.top, props.right);
});
...
function Overlay(_ref) {
  ...
  return React.createElement(StyledOverlay, props, React.createElement(PanelHeader, _extends({
    showCloseIcon: props.isOverlayOpen,
    onCloseIconClick: onCloseIconClick
  }, props), title), React.createElement(StyledPanelBody, null, children));
}

var ResizableOverlay = /*#__PURE__*/function (_React$Component) {
  _inherits(ResizableOverlay, _React$Component);
  ...
  function ResizableOverlay() {
    ...
    _classCallCheck(this, ResizableOverlay);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ResizableOverlay)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(ResizableOverlay, [{
    key: "render",
    value: function render() {
      var isOverlayOpen = this.state.isOverlayOpen;
      var _this$props = this.props,
          title = _this$props.title,
          content = _this$props.content,
          className = _this$props.className;
      return React.createElement(StyledOverlayContainer, {
        className: classNames('invent-overlay-panel', className)
      }, React.createElement(StyledAnalysisIcon, {
        onClick: this.onClick,
        isContentOpen: isOverlayOpen
      }), React.createElement(resizableWrapper.ResizableWrapper, null, React.createElement(Overlay, {
        resizeDir: "left",
        minWidth: 200,
        maxWidth: 600,
        width: 300,
...
module.exports = ResizableOverlay;
