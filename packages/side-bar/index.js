...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["top: 0;"]);
...
var StyledSideBar = styled__default.nav(_templateObject(), function (props) {
  return props.theme.tescoBlueDark;
}, aboveMobileLarge(_templateObject2()), belowMobileLarge(_templateObject3()));
var StyledBadge = styled__default.span(_templateObject4(), function (props) {
  return props.theme.tescoRed;
});
var StyledFiltersIconWrapper = styled__default.div(_templateObject5());
var StyledSideMenu = styled__default.section(_templateObject6(), belowMobileLarge(_templateObject7()), function (props) {
  return "#".concat(props.activeMenuItemId);
}, function (props) {
  return props.theme.tescoHighlightHover;
});

var ADD_ICON = 'addIcon';
var FILTERS_ICON = 'filtersIcon';
var STAR_ICON = 'starIcon';
var SETTINGS_ICON = 'settingsIcon';
var ANALYSIS_ICON = 'analysisIcon';
...
var SideMenu = /*#__PURE__*/function (_React$Component) {
  ...
  function SideMenu() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SideMenu)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(SideMenu, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["children", "activeMenuItemId"]);

      return React.createElement(StyledSideMenu, props, children.map(function (child, i) {
...
var SideBar = function SideBar(_ref) {
  var onMenuItemClick = _ref.onMenuItemClick,
      activeMenuItemId = _ref.activeMenuItemId,
      className = _ref.className,
      filterCount = _ref.filterCount,
      hideIcon = _ref.hideIcon;
  return React.createElement(StyledSideBar, {
    className: classNames('invent-sidebar', className)
  }, React.createElement(SideMenu, {
    onClick: onMenuItemClick,
    activeMenuItemId: activeMenuItemId
  }, !hideIcon[FILTERS_ICON] ? React.createElement(StyledFiltersIconWrapper, null, filterCount > 0 && React.createElement(StyledBadge, null, filterCount), React.createElement(icons.FiltersIcon, {
    id: FILTERS_ICON
  })) : React.createElement(React.Fragment, null), !hideIcon[STAR_ICON] ? React.createElement(icons.StarIcon, {
    id: STAR_ICON
  }) : React.createElement(React.Fragment, null), !hideIcon[SETTINGS_ICON] ? React.createElement(icons.SettingsIcon, {
    id: SETTINGS_ICON
  }) : React.createElement(React.Fragment, null), !hideIcon[ADD_ICON] ? React.createElement(icons.AddIcon, {
    id: ADD_ICON,
    stickyIcon: true
  }) : React.createElement(React.Fragment, null), !hideIcon[ANALYSIS_ICON] ? React.createElement(icons.AnalysisIcon, {
    id: ANALYSIS_ICON,
    mobileOnly: true
