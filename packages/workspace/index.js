...
var _classCallCheck$1 = _interopDefault(require('@babel/runtime/helpers/classCallCheck'));
var _possibleConstructorReturn$1 = _interopDefault(require('@babel/runtime/helpers/possibleConstructorReturn'));
var _getPrototypeOf$2 = _interopDefault(require('@babel/runtime/helpers/getPrototypeOf'));
var _assertThisInitialized$2 = _interopDefault(require('@babel/runtime/helpers/assertThisInitialized'));
var _createClass$1 = _interopDefault(require('@babel/runtime/helpers/createClass'));
var _inherits$1 = _interopDefault(require('@babel/runtime/helpers/inherits'));
...
var panel = require('@invent/panel');
var Canvas = _interopDefault(require('@invent/canvas'));
var resizableWrapper = require('@invent/resizable-wrapper');
var SideBar = _interopDefault(require('@invent/side-bar'));
...
var BrowserEventEmitter = function () {
  function BrowserEventEmitter() {
    ...
    _classCallCheck$1(this, BrowserEventEmitter);
  ...
  _createClass$1(BrowserEventEmitter, [{
    key: "on",
...
var BreakpointChange = function (_React$Component) {
  _inherits$1(BreakpointChange, _React$Component);

  _createClass$1(BreakpointChange, null, [{
    key: "_getBodyMargins",
  ...
  function BreakpointChange(props) {
    ...
    _classCallCheck$1(this, BreakpointChange);

    _this = _possibleConstructorReturn$1(this, _getPrototypeOf$2(BreakpointChange).call(this, props));

    _defineProperty$1(_assertThisInitialized$2(_this), "_breakpointOrder", (_defineProperty2 = {}, _defineProperty$1(_defineProperty2, MOBILE, 1), _defineProperty$1(_defineProperty2, MOBILE_LARGE, 2), _defineProperty$1(_defineProperty2, TABLET, 3), _defineProperty$1(_defineProperty2, TABLET_LARGE, 4), _defineProperty$1(_defineProperty2, DESKTOP, 5), _defineProperty$1(_defineProperty2, DESKTOP_LARGE, 6), _defineProperty2));

    _defineProperty$1(_assertThisInitialized$2(_this), "_breakpoints", void 0);

    _defineProperty$1(_assertThisInitialized$2(_this), "_browserEventEmitter", browserEventEmitter);

    _defineProperty$1(_assertThisInitialized$2(_this), "_onResize", function () {
  ...
  _createClass$1(BreakpointChange, [{
...
var WindowResize = function (_React$Component) {
  _inherits$1(WindowResize, _React$Component);

  _createClass$1(WindowResize, null, [{
  ...
  function WindowResize(props) {
    ...
    _classCallCheck$1(this, WindowResize);

    _this = _possibleConstructorReturn$1(this, _getPrototypeOf$2(WindowResize).call(this, props));

    _defineProperty$1(_assertThisInitialized$2(_this), "_browserEventEmitter", browserEventEmitter);

    _defineProperty$1(_assertThisInitialized$2(_this), "_onOrientationChange", function () {
    ...
    _defineProperty$1(_assertThisInitialized$2(_this), "_onWindowResize", function () {
...
function _templateObject9() {
  var data = _taggedTemplateLiteral(["margin-left: 0;"]);
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["grid-template-columns:0 1fr 0;"]);
...
var StyledWorkspaceTemplate = styled__default.div(_templateObject(), belowMobileLarge(_templateObject2()));
var StyledPanel = styled__default(panel.Panel)(_templateObject3(), aboveMobileLarge(_templateObject4(), function (props) {
  return props.isPanelOpen && styled.css(_templateObject5(), function (props) {
    return "".concat(props.width || 169, "px");
  });
}), belowMobileLarge(_templateObject6(), function (props) {
  return props.isPanelOpen && styled.css(_templateObject7());
}));
var StyledCanvas = styled__default(Canvas)(_templateObject8(), belowMobileLarge(_templateObject9()), function (props) {
  return props.isPanelOpen && styled.css(_templateObject10(), props.panelWidth);
});
...
var Workspace = /*#__PURE__*/function (_React$Component) {
  ...
  function Workspace() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Workspace)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "onMenuItemClick", function (event) {
      var id = event.target.id;
      var panelMetadata = _this.props.panelMetadata;

      var _ref = panelMetadata[id] || {},
          togglePanel = _ref.togglePanel,
          callback = _ref.callback;

      togglePanel && _this.setState(function (prevState) {
        return {
    ...
    _defineProperty(_assertThisInitialized(_this), "onCloseIconClick", function () {
      _this.setState({
        isPanelOpen: false,
        activeToggle: ""
      });
  ...
  _createClass(Workspace, [{
    key: "render",
    value: function render() {
      var _panelMetadata$active, _panelMetadata$active2;

      var _this$state = this.state,
          isPanelOpen = _this$state.isPanelOpen,
          activeToggle = _this$state.activeToggle,
          panelWidth = _this$state.panelWidth;
      var _this$props = this.props,
          panelMetadata = _this$props.panelMetadata,
          canvasContent = _this$props.canvasContent,
          className = _this$props.className;
      return React.createElement(StyledWorkspaceTemplate, {
        id: "workspace",
        className: classNames('invent-workspace', className)
        ...
        hideIcon: panelMetadata ? Object.fromEntries(Object.entries(panelMetadata).map(function (_ref2) {
      ...
      }), React.createElement(resizableWrapper.ResizableWrapper, {
        ...
        minWidth: 170,
        maxWidth: 530,
        title: activeToggle && ((_panelMetadata$active = panelMetadata[activeToggle]) === null || _panelMetadata$active === void 0 ? void 0 : _panelMetadata$active.title),
        onCloseIconClick: this.onCloseIconClick,
        width: panelWidth
      }, activeToggle && ((_panelMetadata$active2 = panelMetadata[activeToggle]) === null || _panelMetadata$active2 === void 0 ? void 0 : _panelMetadata$active2.content))), React.createElement(StyledCanvas, {
