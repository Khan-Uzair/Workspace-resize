...
var StyledResizableWrapper = styled__default.div(_templateObject(), function (props) {
  return props.resizeDir === "left" ? "row-reverse" : "row";
}, function (props) {
  return props.width;
}, function (props) {
  return props.isDragging && styled.css(_templateObject2());
}, belowMobileLarge(_templateObject3()));

var ResizableWrapper = /*#__PURE__*/function (_React$Component) {
  _inherits(ResizableWrapper, _React$Component);

  function ResizableWrapper(props) {
    var _this;

    _classCallCheck(this, ResizableWrapper);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ResizableWrapper).call(this, props));

    _defineProperty(_assertThisInitialized(_this), "startResize", function (event) {
      _this.setState({
        isDragging: true,
    ...
    _defineProperty(_assertThisInitialized(_this), "stopResize", function () {
      if (_this.state.isDragging) {
        ...
        var _children$props = children.props,
            minWidth = _children$props.minWidth,
            maxWidth = _children$props.maxWidth;
        ...
        _this.setState(function (_ref) {
          ...
          return {
            isDragging: false,
            panelWidth: _this.limitWithin(panelWidth + delta, minWidth, maxWidth),
            delta: 0
          };
        });
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "resizePanel", function (event) {
      if (_this.state.isDragging) {
        ...
        var _children$props2 = children.props,
            minWidth = _children$props2.minWidth,
            maxWidth = _children$props2.maxWidth,
            resizeDir = _children$props2.resizeDir;
        var delta = resizeDir === "right" ? event.clientX - _this.state.initialPos : _this.state.initialPos - event.clientX;

        var panelWidth = _this.limitWithin(_this.state.panelWidth + _this.state.delta, minWidth, maxWidth);
        ...
        _this.setState(function () {
          ...
          if (_this.props.onResizeEnd) {
            _this.props.onResizeEnd(panelWidth);
          }
        });
      }
    });
  ...
  _createClass(ResizableWrapper, [{
    ...
    key: "limitWithin",
    value: function limitWithin(val, min, max) {
    ...
    value: function render() {
      ...
      var _children$props3 = children.props,
          minWidth = _children$props3.minWidth,
          maxWidth = _children$props3.maxWidth,
          resizeDir = _children$props3.resizeDir,
          isPanelOpen = _children$props3.isPanelOpen;
      panelWidth = this.limitWithin(panelWidth + delta, minWidth, maxWidth);
      var panel = React.cloneElement(this.props.children, {
        width: isPanelOpen ? panelWidth : 0
      });
      return React.createElement(StyledResizableWrapper, {
        resizeDir: resizeDir,
        width: isPanelOpen ? panelWidth : 0,
        isDragging: isDragging,
        className: classNames('invent-resizable-wrapper', className)
      }, panel, React.createElement(icons.ResizeIcon, {
...
exports.ResizableWrapper = ResizableWrapper;
